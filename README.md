...
The bundled indexer parses **TypeScript, TSX, JavaScript, JSX, Python, Go, Java, C, C++, and C#**. Grammars load lazily — one per language, on first sight of a matching file — so a Go-only workspace never loads a Python grammar.
